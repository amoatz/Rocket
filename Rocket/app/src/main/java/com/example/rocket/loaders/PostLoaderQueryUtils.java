...
public class PostLoaderQueryUtils {

    public static String fetchUrlData(String stringUrl, int mclientId, int voteValue, int locationId,
                                      String commentText){
        ...
        try {
            ...
            jsonResponse = makeHttpRequest(url,mclientId,voteValue,locationId,commentText);
        } catch (IOException e) {
            Log.e("Message"," ",e);
        }
...
// Return
    ...
    private static String makeHttpRequest(URL url,
        ...
        try{
            ...
            String jsonInputString = "{\"customerId\": \""+clientID
                    +"\", \"vote\": \""+voteValue
